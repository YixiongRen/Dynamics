...
str101 = ['Maximal Displacement of Disk with \mu\_x=', num2str(mu_x),'\mu\_y=' , num2str(mu_y),' and Fn=', num2str(fnormal)];
title(str101);
...
str102 = ['Maximal Displacement of Blade with \mu\_x=', num2str(mu_x),'\mu\_y=' , num2str(mu_y),' and Fn=', num2str(fnormal)];
title(str102);

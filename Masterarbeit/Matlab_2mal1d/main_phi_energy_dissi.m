...
% -------------------------------------------------------------------------
    for iit = 1: iitmax 
        ...
        [fnlcontx,fnlconty,dFdQx,dFdQy, contactflag, contactstatus,~] = calc_nonlinfricforce_dissi (Qcont,kt,fnormal,mu_x,mu_y,0,0);
...
%        dQ = -pinv(J)*R; 
        ...
        for inew = 0:newdamp
            ...
            if (norm.dQ/norm.Q) < epsilon
                ...
                convergence = 1;
                [fnlcontx,fnlconty,dFdQx,dFdQy, contactflag, contactstatus,totalenergy] = calc_nonlinfricforce_dissi (Qcont,kt,fnormal,mu_x,mu_y,0,1);

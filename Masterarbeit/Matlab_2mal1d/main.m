...
fl  = [0; 0; 0; 0; 20; 0; 20; 0]; % f = [......; f_b_x,c; f_b_x,s; f_b_y,c; f_b_y,s]
fnl = [0; 0; 0; 0; 0; 0; 0; 0;];
...
figure(5)
h(i,1) = semilogy(freqrange,abs(Qvec_disk(:,1))); hold on
ylabel('Displacement [m]')
xlabel('Frequency [Hz]')
str101 = ['Maximal Displacement of Disc in x-axis with \mu\_x=', num2str(mu_x),'and \mu\_y=', num2str(mu_y)];
title(str101);
% legend('Disk\_x');
grid on
figure(6)
h(i,2) = semilogy(freqrange,abs(Qvec_disk(:,2))); hold on
ylabel('Displacement [m]')
xlabel('Frequency [Hz]')
str101 = ['Maximal Displacement of Disc in y-axis with \mu\_x=', num2str(mu_x),'and \mu\_y=', num2str(mu_y)];
title(str101);
% legend('Disk\_x');
grid on

figure(7)
h(i,3) = semilogy(freqrange,abs(Qvec_blade(:,1))); hold on
ylabel('Displacement [m]')
xlabel('Frequency [Hz]')
str101 = ['Maximal Displacement of Blade in x-axis with \mu\_x=', num2str(mu_x),'and \mu\_y=', num2str(mu_y)];
title(str101);
% legend('Blade\_x');
grid on
figure(8)
h(i,4) = semilogy(freqrange,abs(Qvec_blade(:,2))); hold on
ylabel('Displacement [m]')
xlabel('Frequency [Hz]')
str101 = ['Maximal Displacement of Blade in y-axis with \mu\_x=', num2str(mu_x),'and \mu\_y=', num2str(mu_y)];
title(str101);
% legend('Blade\_x');
grid on
% hold on
...
%%
set(h(1,1),'Color','r','LineStyle','-','DisplayName','Fn = 2 N')
set(h(2,1),'Color','r','LineStyle','--','DisplayName','Fn = 4 N')
set(h(3,1),'Color','r','LineStyle',':','DisplayName','Fn = 8 N')
set(h(4,1),'Color','r','LineStyle','-.','DisplayName','Fn = 16 N')
set(h(5,1),'Color','g','LineStyle','-','DisplayName','Fn = 32 N')
set(h(6,1),'Color','g','LineStyle','--','DisplayName','Fn = 64 N')
set(h(7,1),'Color','g','LineStyle',':','DisplayName','Fn = 128 N')
set(h(8,1),'Color','g','LineStyle','-.','DisplayName','Fn = 256 N')
set(h(9,1),'Color','b','LineStyle','-','DisplayName','Fn = 512 N')
legend show
set(h(1,2),'Color','r','LineStyle','-','DisplayName','Fn = 2 N')
set(h(2,2),'Color','r','LineStyle','--','DisplayName','Fn = 4 N')
set(h(3,2),'Color','r','LineStyle',':','DisplayName','Fn = 8 N')
set(h(4,2),'Color','r','LineStyle','-.','DisplayName','Fn = 16 N')
set(h(5,2),'Color','g','LineStyle','-','DisplayName','Fn = 32 N')
set(h(6,2),'Color','g','LineStyle','--','DisplayName','Fn = 64 N')
set(h(7,2),'Color','g','LineStyle',':','DisplayName','Fn = 128 N')
set(h(8,2),'Color','g','LineStyle','-.','DisplayName','Fn = 256 N')
set(h(9,2),'Color','b','LineStyle','-','DisplayName','Fn = 512 N')
legend show
set(h(1,3),'Color','r','LineStyle','-','DisplayName','Fn = 2 N')
set(h(2,3),'Color','r','LineStyle','--','DisplayName','Fn = 4 N')
set(h(3,3),'Color','r','LineStyle',':','DisplayName','Fn = 8 N')
set(h(4,3),'Color','r','LineStyle','-.','DisplayName','Fn = 16 N')
set(h(5,3),'Color','g','LineStyle','-','DisplayName','Fn = 32 N')
set(h(6,3),'Color','g','LineStyle','--','DisplayName','Fn = 64 N')
set(h(7,3),'Color','g','LineStyle',':','DisplayName','Fn = 128 N')
set(h(8,3),'Color','g','LineStyle','-.','DisplayName','Fn = 256 N')
set(h(9,3),'Color','b','LineStyle','-','DisplayName','Fn = 512 N')
legend show
set(h(1,4),'Color','r','LineStyle','-','DisplayName','Fn = 2 N')
set(h(2,4),'Color','r','LineStyle','--','DisplayName','Fn = 4 N')
set(h(3,4),'Color','r','LineStyle',':','DisplayName','Fn = 8 N')
set(h(4,4),'Color','r','LineStyle','-.','DisplayName','Fn = 16 N')
set(h(5,4),'Color','g','LineStyle','-','DisplayName','Fn = 32 N')
set(h(6,4),'Color','g','LineStyle','--','DisplayName','Fn = 64 N')
set(h(7,4),'Color','g','LineStyle',':','DisplayName','Fn = 128 N')
set(h(8,4),'Color','g','LineStyle','-.','DisplayName','Fn = 256 N')
set(h(9,4),'Color','b','LineStyle','-','DisplayName','Fn = 512 N')
legend show